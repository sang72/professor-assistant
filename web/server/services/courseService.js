...
export async function initializeLectureFile(folder, week, session, force = false) {
  try {
    ...
    const template = `# Week ${week} · Session ${session}: [Title Here]

## ${course.course_code} — ${course.course_name}
**Professor:** ${course.professor_name}
**Semester:** ${course.semester}
**Delivery Language:** ${course.delivery_language}
...
## SECTION 2: FULL LECTURE SCRIPT (${isKorean ? '한국어' : course.delivery_language})

### Opening (3 minutes)

[Start with an engaging hook related to today's topic. Introduce the learning objectives.]

### Main Content (32 minutes)

[Provide detailed, comprehensive explanation of the main concepts. Align with PowerPoint slides. Include examples and case studies.]

### Summary & Q&A (2 minutes)

[Summarize key learning points. Open for student questions.]
...
[오늘의 주제와 관련된 흥미로운 시작. 학습 목표 소개]

### 주요 내용 (32분)

[주요 개념에 대한 자세한 설명. PowerPoint 슬라이드와 일치. 예시 및 사례 포함]

### 요약 및 질의응답 (2분)

[핵심 학습 포인트 요약. 학생 질문 개방]

` : ''}

---

## SECTION 3: PowerPoint SLIDE OUTLINE (영어)
...
[One concept per slide. Use bullet points, visuals, and minimal text.]
...
### References
- [Textbook chapters if applicable]
